		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#projectopdracht-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectopdracht-display": {
								"semanticObject": "projectopdracht",
								"action": "display",
								"description": "Project opdracht - ERP Advanced - Movements ",
								"title": "Movements Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectopdracht",
									"url": sap.ui.require.toUrl("projectopdracht")
								}
							}
						}
					}
